...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="customer">
					<h2><strong>NOTICE11</strong><span>쟈뎅샵 소식을 전해드립니다.11</span></h2>
					<div class="viewDivMt">
						<div class="viewHead">
							<div class="subject">
								<ul>
					...
					<script>
						$(function(){
							...
							$(".replyBtn").click(function(){
								...
								$.ajax({
									 ...
									 success:function(data){
										...
										$("#comment_number").text(Number($("#comment_number").text())+1);	// 개수 1개 넣기
										$(".replynum").val("");
										$(".replyType").val("");
							...
							$(document).on("click",".dBtn",function(){
								...
								console.log("삭제버튼 id : "+$(this).closest('ul').attr('id'));
								...
								$.ajax({
									 ...
									 success:function(data){
										alert("댓글이 삭제되었습니다");
										$("#"+cno).remove();
										$("#comment_number").text(Number($("#comment_number").text())-1);	// 개수 1개 빼기
									 },
									 error:function(){
										 alert("실패");
									 }
							...
							$(document).on("click",".uBtn",function(){
								alert("댓글을 수정합니다.");
								console.log("수정버튼 id : "+$(this).closest('ul').attr('id'));
								...
								console.log("수정 cno : "+cno);
								console.log("수정 id : "+id);
								console.log("수정 cdate : "+cdate);
								console.log("수정 ccontent : "+ccontent);
								...
								htmlData+='<a class="rebtn cancleBtn">취소</a>';
								htmlData+='</li>';
							...
							$(document).on("click",".cancleBtn",function(){
								alert("취소버튼 클릭하셨네요");
								console.log("수정취소버튼 id : "+$(this).closest('ul').attr('id'));
								console.log("수정취소 cno : "+cno);
								console.log("수정취소 id : "+id);
								console.log("수정취소 cdate : "+cdate);
								console.log("수정취소 ccontent : "+ccontent);
							...
							$(document).on("click",".updateBtn",function(){
								alert("댓글 수정 완료 버튼 클릭하셨네요~");
								
								ccontent = $(this).closest('ul').children('.txt').children('.replyType').val();
								
								console.log("수정완료 cno : "+cno);
								console.log("수정완료 id : "+id);
								console.log("수정완료 ccontent : "+ccontent);
								// 수정완료 누를 시 controller로 전송하기
								$.ajax({
