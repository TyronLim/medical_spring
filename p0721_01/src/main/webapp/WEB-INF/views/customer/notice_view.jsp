				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								<p class="txt">작성일<span>${nDto.created_time}</span></p>
							</div>
						</div>
					...
					$(function(){
						...
						$(".replyBtn").click(function(){
							...
							let board_no = "${rDto.bno}";
							let user_id = $(".name").val();
							let rdata = ${rDto.rdata};
							let rcontent = $(".replynum").val();
							let user_pw = #(".replynum").val();
							
							console.log("bno : " + board_no);
							console.log("id : " + user_id);
							console.log("cpw : " + user_pw);
							console.log("ccontent : " + rcontent);
							
							
							$.ajax({
								url:"/customer/commentBwrite",
								type:"post",
								data:{"board_no":board_no,"user_id":user_id,"rdata":rdata,"rcontent":rcontent},
								dataType:"json",
								success:function(data){
									...
									htmlData +='<li class="name">'+data.user_id+'['+data.rdata+']</span></li>';
									htmlData +='<li class="txt">'+data.rcontent+'</li>';
					...
					<div class="replyBox">
						...
						<c:if test="${list.size()>0}">
							<c:forEach items="${list}" var="rDto">
								<ul>
									<li class="name">${rDto.user_id}<span>[${rDto.rdata}]</span></li>
									<li class="txt">${rDto.rcontent}</li>
									<li class="btn">
