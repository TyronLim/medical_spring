...
public class EmailServiceImpl implements EmailService {
	...
	public void email_send(String name, String email) {
		...
		System.out.println("랜덤 비번"+pwCode);
		// 문자만 전송
		SimpleMailMessage message = new SimpleMailMessage();
		message.setTo(email);
		message.setFrom("gihvdh@gmail.com");
		message.setSubject(name+"님의 임시 비밀번호입니다. by 태균");
	...
	public void email_send2(String name, String email) {
		...
		try {
		message.setSubject("[안내]"+name+"님의 비밀번호 초기화","UTF-8");
		String htmlData = "<tr>	<td style='width:700px;height:196px;padding:0;margin:0;vertical-align:top;'> "
				+ "<table width='618' height='194' cellpadding='0' cellspacing='0' align='center' style='margin:0 0 0 40px;border:1px #D9D9D9 solid;'> "
				+ "<tr> <td style='width:618px;height:194px;padding:0;margin:0;vertical-align:top;font-size:0;line-height:0;background:#f9f9f9;'> "
				...
				+ "<p style='width:620px;margin:30px 0 0 0;padding:0;text-align:center;color:#888888;font-size:12px;line-height:1.4;'>쟈뎅샵에서는 고객님께 보다 나은 서비스를 제공하기 위해 항상 노력하고 있습니다.<br/>앞으로 많은 관심 부탁드립니다.</p> </td> </tr> </table>		"
				+ "</td></tr>";
		message.setText(htmlData,"utf-8","html");
		//보내는 메일 주소
		message.setFrom(new InternetAddress("gihvdh@gmail.com"));
		//받는 메일 주소
